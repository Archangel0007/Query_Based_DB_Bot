...
Use the following pre-existing functions from db_utils to coinnect to the database:
from db_utils import get_db_connection
...
if __name__ == "__main__":
    generate_script("Run_Space/metadata.json", "Run_Space/relationship_schema.puml", "Run_Space/create_Database_Script.py", model="gemini-2.5-flash")
